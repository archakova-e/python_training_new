...
class TestAddContact(unittest.TestCase):
    ...
    def fill_contact_properties(self, wd, contact_properties):
        # fill contact names
    ...
    def test_add_contact(self):
        ...
        self.fill_contact_properties(wd, ContactProperties(firstname="Ivan", middlename="Ivanich", lastname="Ivanov",
